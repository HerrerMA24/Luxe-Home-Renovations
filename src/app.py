...
def navigation_bar():
    ...
    with st.container():
        ...
        with col1:
            st.markdown("""<a href="#" class="navbar-brand">LHR</a>""", unsafe_allow_html=True)
        with col2:
            if "token" not in st.session_state:
                ...
                st.markdown("""<div class="navbar-center">Authenticated</div>""", unsafe_allow_html=True)
        with col3:
            st.markdown("""<a href="#" class="navbar-link">About</a>""", unsafe_allow_html=True)
